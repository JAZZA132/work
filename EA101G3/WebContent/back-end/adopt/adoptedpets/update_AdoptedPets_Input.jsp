		...
		<div class="row">
			<div class="col">
				<form method="post" enctype="multipart/form-data"
					...
					<fieldset disabled>
						<div class="form-group row">
							<label for="petNo">收容寵物編號</label> <input type="text" name="petNo"
								id="petNo" class="form-control" value="${adoptedpetsVO.petNo}">
						</div>
					</fieldset>
					<div class="form-group row">
					...
					<div class="form-group row">
						<label for="adoptDate">領養日期</label> <input type="text"
							class="form-control" name="adoptDate" id="adoptDate"
							value='${adoptedpetsVO.adoptDate}'>
					</div>
					<div class="form-group row">
						<label for="interviewDate">訪查日期</label> <input type="text"
							class="form-control" name="interviewDate" id="interviewDate"
							value='${adoptedpetsVO.interviewDate}'>
					</div>
					<div class="form-group row">
						<label for="interviewInfo">訪查內容</label>
						<textarea class="form-control" name="interviewInfo"
							id="interviewInfo" rows="3"></textarea>
					</div>
					<div class="form-group row">

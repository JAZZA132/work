...
<jsp:useBean id="listQueue1C" scope="request" type="java.util.List<OptVO>" />
...
<meta http-equiv="refresh" content="10;URL=<%=request.getContextPath()%>/front-end/hospital/appt/queue1C.jsp">
<link rel="stylesheet"
...
<c:choose>
    ...
    <c:forEach var="optVO" items="${listQueue1C}">
        <i class="fas fa-user-md"></i>目前看診號${optVO.currentCount+1-(fn:length(listQueue1C))} <br><br><br><br><br>
     </c:forEach>
    </c:otherwise>

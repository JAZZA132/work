					...
					<form method="post" enctype="multipart/form-data"
						...
						<fieldset disabled>
							<div class="form-group row">
								<label for="petNo">會員名稱</label> <input type="text"
						...
						<div class="form-group row">
							<label for="petNo">寵物姓名</label> <input type="text" name="petName"
								id="petName" class="form-control" value="${memberPetVO.petName}"
								required>
						</div>
						...
						<div class="form-group row">
							<label for="petBreed">寵物年齡</label> <input type="text"
							...
							<div class="col">
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="petGender"
										...
										class="form-check-label" for="petGender1">男</label>
								</div>
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="petGender"
										id="petGender2" value="女"> <label
										class="form-check-label" for="petGender2">女</label>
								</div>
							</div>
						</div>
						...
						<input type="hidden" name="petStatus" value="0">

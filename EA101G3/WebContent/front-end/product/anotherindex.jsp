...
<link rel="stylesheet" href="<%= request.getContextPath()%>/front-end/product/anotherindex.css">
<!-- bootstrap、FontAwesome、googleFont -->
<style>
.myjumbotron {
	background-image: url("<%=request.getContextPath()%>/front-end/product/img/2.jpg");
	...
	<div class="container">
		...
		<div
			...
			<div class="col-md-6 px-0">
				<h1 class="display-4 font-italic text-dark">歡迎來到其他專區</h1>
				...
				<button class="btn btn-outline-info my-2 my-sm-0" id="btn">搜尋商品</button>
			...
			$(document).ready(function(){
				$("#btn").click(function(){
					$.ajax({
						...
						type:"POST",
						data:{action:"selectanother", productname: $("#productname").val() },
						dataType:"json",

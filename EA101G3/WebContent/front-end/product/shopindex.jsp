		...
		<div class="modal-dialog" id="newpost" role="document">
			<div class="modal-content">
				<div class="modal-header bg-info">
					<h5 class="modal-title text-white">新上架商品,還不快買爆!</h5>
			...
			<div class="modal-footer bg-info">
				...
				<button id="reload" type="button" class="btn btn-secondary" data-dismiss="modal">確定</button>
			</div>
		</div>
	</div>
</div>
	...
	<div class="container">
		...
		<div
			...
			<div class="col-md-6 px-0">
				<h1 class="display-4 font-italic text-dark">歡迎來到寵物商城</h1>

...
<link rel="stylesheet" href="<%=request.getContextPath()%>/front-end/Hotel/hotel-pay/style.css">
...
<body>
	...
	<div class="container-fluid mt-3 text_label">
	...
	<script src="<%=request.getContextPath()%>/front-end/Hotel/hotel-pay/pay.js"></script>

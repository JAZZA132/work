...
public class InteractionService {
	...
	public InteractionVO addInteraction(String petNo, String adopterNo, java.sql.Timestamp interactionDate,
			String interactionStatus, Integer adoptDesire) {
	...
	public InteractionVO updateInteraction(String interactionNo, String petNo, String adopterNo,
			java.sql.Timestamp interactionDate, String interactionStatus, Integer adoptDesire) {
	...
	public Set<InteractionVO> getInteractionByPetNo(String petNo) {
